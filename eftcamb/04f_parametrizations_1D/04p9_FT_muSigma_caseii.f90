...
!> @file 04p9_FT_muSigma_caseii.f90
!! File contains the parameterization of mu-Sigma case II of the thesis of Fre Vink.
!! File copied from 04p2_linear_parameterizations_1D.f90.
...
module EFTCAMB_FV_muSigma_caseii
...
contains
    ...
    subroutine LinearParametrized1DSetParamNumber( self )
        ...
        class(FV_muSigma_caseii) :: self       !< the base class
    ...
    subroutine LinearParametrized1DFeedback( self, print_params )
...
end module EFTCAMB_FV_muSigma_caseii
